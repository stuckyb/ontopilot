...
rem The location of the main tables2txt program, relative to this launch
rem script.
set TABLES2TXTPATH=..\python-src\ontopilot_main.py
...
rem Run tables2txt, passing on all command-line arguments.
%JAVAPATH% -jar "%SRCDIR%%JYTHONPATH%" "%SRCDIR%%TABLES2TXTPATH%" %*
